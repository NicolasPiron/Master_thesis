...
def plot_tfr_population(input_dir, output_dir, subject_list, population):
    ...
    # Plot the time-frequency representation
    for condition, tfr in tfr_dict.items():
        fig1 = tfr.plot_joint(timefreqs=((0.1, 10),(0.2,10),(0.3,10)), tmin=0, tmax=0.6, fmin=8, fmax=30, vmin=-0.0000000009, vmax=0.0000000009,
                               topomap_args={'vlim': (-0.0000000009,0.0000000009)},
