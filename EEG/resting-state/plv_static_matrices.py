...
group_dict = {'old_control':old_control, 'young_control':young_control, 'thal_control':thal_control, 'pulvinar':pulvinar}
    ...
    for subject in subject_list:
        ...
        for metric in metric_list:
            for freqs in freqs_list:
                try:
                    print(f'Creating matrix for subject {subject}, {metric}, {freqs}')
